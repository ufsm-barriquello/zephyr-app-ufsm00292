...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HEAP_MEM_POOL_ADD_SIZE_SOC, 1024);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HWINFO_SAM0, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DC_SAM0, 1);
